...
This song is taken from my latest CD, "Dreamstate" (1995). I have
...
3) In User Bank 1, locate the "AWEDIGPH.SBK" file, and double-click on
...
* Fixed tuning in preset **000:003 Steel-str.Gt**. AWE32 recording needed to verify.
